...
#define CONFIG_MEM_LOAD_ADDR                0x32000000
#define CFG_MEM_PHY_SYSTEM_SIZE             0x02000000
...
int nand_make_parts(int dev, uint64_t (*parts)[2], int count)                           
{
