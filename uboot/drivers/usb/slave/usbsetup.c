...
static const U8 fastboot_device_name[] = {"s3c2440 dev"};
...
void Ep0Handler(void)
{
    ...
    {	
        ...
        case EP0_STATE_GD_CFG_1:
            //            DbgPrintf("[GDC1]");
            WrPktEp0((U8 *)&descConf + 8, 1);   //maxpower
        ...
        case EP0_STATE_GD_STR_I0:
            ...
            //WrPktEp0((U8 *)fastboot_device_name, 11);  
            SET_EP0_INPKTRDY_DATAEND();
            ep0State = EP0_STATE_INIT;     
            ep0SubState = 0;
            break;
...
{	
    ...
    //descDev.bDeviceSubClass = 0x42;
    //descDev.bDeviceProtocol = 0x03;          
    ...
    //descConf.wTotalLengthL=0x40; //<cfg desc>+<if desc>+<endp0 desc>+<endp1 desc>
    ...
    descIf.bInterfaceSubClass=0x42;  
    descIf.bInterfaceProtocol=0x03;
